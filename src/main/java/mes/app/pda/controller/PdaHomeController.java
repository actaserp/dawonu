...
public class PdaHomeController {
    ...
    private static final String version_file = "C:/Temp/mes21/dawonupda/version.json";
    ...
    @GetMapping("/pda/app/version/dawonupda_latest.apk")
    public ResponseEntity<Resource> downloadApk(@RequestParam String version){
        try{
            String apkPath = "C:/Temp/mes21/dawonupda/" + "app_" + version + ".apk";
